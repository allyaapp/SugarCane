                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <?php 
                                        ...
                                        $data = mysqli_query($koneksi, "SELECT * FROM admindetail");
                                        $jumlah_data = mysqli_num_rows($data);
                                        $total_halaman = ceil($jumlah_data / $batas);

                                        $query = "SELECT * FROM admindetail limit $halaman_awal, $batas";
                                ...
                                <nav>
                                    <ul class="pagination table-bordered">
                                        <li>
                                            <a class="waves-effect" <?php if($halaman > 1){ echo "href='adminhome.php?halaman=$previous'";} ?> >
                                                PREVIOUS
                                        ...
                                        ?>
                                            <li><a class="waves-effect" href="adminhome.php?halaman=<?php echo $x ?>"><?php echo $x; ?><!-- &nbsp;&nbsp;| --></a></li>
                                        <?php
                                            }
                                        ?>  

                                        <li>
                                            <a class="waves-effect" <?php if($halaman < $total_halaman){ echo "href='adminhome.php?halaman=$next'";} ?>>
                                                NEXT
