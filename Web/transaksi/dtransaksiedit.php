...
$path = '../images/admin/';
    ...
    if(isset($_POST['update']) ){
        ...
        if (!$result) {
            ...
            echo "<script> location='dtransaksiedit.php'; </script>";
        } else {
...
<head>
    ...
    <title>Edit Transaction Detail | SUGAR CANE</title>
    <!-- Favicon-->
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="dtransaksiedit.php">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="id_barang" value="<?php echo $id_barang;?>" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="subharga" value="<?php echo $subharga;?>" required>
